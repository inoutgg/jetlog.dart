...
void main() {
  group('Interface', () {
    ...
    group('#lazy', () {
      ...
      setUp(() {
        logger = Logger.detached()..level = Level.all;
      });

      test('it exists', () {
        expect(logger.lazy, isNotNull);
      });

      group('#log', () {
        test('it does not throw', () {
          expect(() => logger.lazy.log(Level.danger, () => 'log'),
              returnsNormally);
        });

        test('it evaluates only when necessary', () {
          var flag = false;
          logger.level = Level.danger;
      ...
      group('#trace', () {
        test('it does not throw', () {
          expect(() => logger.lazy.trace(() => 'trace'), returnsNormally);
        });
      ...
      group('#debug', () {
        test('it does not throw', () {
          expect(() => logger.lazy.debug(() => 'debug'), returnsNormally);
        });
      });

      group('#info', () {
        test('it does not throw', () {
          expect(() => logger.lazy.info(() => 'info'), returnsNormally);
        });
      });

      group('#warning', () {
        test('it does not throw', () {
          expect(() => logger.lazy.warning(() => 'warning'), returnsNormally);
        });
      });

      group('#danger', () {
        test('it does not throw', () {
          expect(() => logger.lazy.danger(() => 'danger'), returnsNormally);
        });
      });

      group('#fatal', () {
        test('it does not throw', () {
          expect(() => logger.lazy.fatal(() => 'fatal'), returnsNormally);
        });
      });
    });
  });
