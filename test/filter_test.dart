...
import 'package:structlog/structlog.dart'
    show FiltererBase, Filter, FilterRegisterError, Level, Record;
import 'package:structlog/src/record_impl.dart';

class _TestFilterer with FiltererBase {}
    ...
    group('#removeFilter', () {
      ...
      group('#clearFilters', () {
        test('removes all filters', () {
          ...
          expect(filterer.filter(record1), isFalse);
          expect(filterer.filter(record2), isFalse);

          filterer.clearFilters();
